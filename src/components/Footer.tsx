...
function SocialLink({ href, label, children }: { href: string; label: string; children: React.ReactNode }) {
  ...
  return (
    <a
      ...
      onMouseEnter={lift.onMouseEnter}
      onMouseLeave={lift.onMouseLeave}
      style={{ display: "inline-flex", lineHeight: 0, ...lift.style }}
    >
      {children}
    </a>
  );
...
function LinkedInSvg() {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ flexShrink: 0 }}>
      <path d="M19.33 0.71V0H0.685V0.735H0V19.28H0.71V20H19.28V19.29H20.02V0.71H19.33ZM19.26 18.515H18.565V19.255H1.42V18.48H0.71V1.39H1.42V0.725H18.525V1.355H19.26V18.515Z" fill="#101010" />
      <path d="M7.06 7.825H4.815V15.83H7.135V7.825H7.06Z" fill="#101010" />
      <path d="M7.06 4.155H4.84V4.865H4.205V6.355H4.815V7.065H7.06V6.355H7.69V4.865H7.06V4.155Z" fill="#101010" />
      <path d="M15.78 10.02V9.335H15.07V8.575H14.385V7.84H11.43V8.54H10.695V7.825H8.525V15.83H10.695V10.68H11.455V9.97H12.92V10.68H13.63V15.83H15.85V10.02H15.78Z" fill="#101010" />
    </svg>
  );
}
